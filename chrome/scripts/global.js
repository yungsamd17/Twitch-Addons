...
const observer1 = new MutationObserver(createScreenshotButton);
const observer1Options = {
    childList: true,
    subtree: true,
};

observer1.observe(document.body, observer1Options);
...
// MutationObserver to watch for DOM changes
const observer2 = new MutationObserver(createClipDownloadButton);
const observer2Options = {
    childList: true,
    subtree: true,
};
observer2.observe(document.body, observer2Options);
